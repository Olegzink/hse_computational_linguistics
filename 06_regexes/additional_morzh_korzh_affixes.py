...
##################
# Version 1: Substitute all entries of 'морж' with affixes 'моржей', 'моржа' etc.
##################
...
patterns_dict = {'корж': re.compile(r'морж'),
                 'Корж': re.compile(r'Морж')}

text_all_entries = text

for res, origin in patterns_dict.items():
    text_all_entries = re.sub(origin, res, text_all_entries)

print(text_all_entries)
